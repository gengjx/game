    ...
    <div class="a" >
        <el-container  style="height: 100%">
            <el-header style="height: 5%">
                ...
                <span class="el-dropdown-link">
                        ...
                        <el-dropdown-menu slot="dropdown">
                            ...
                            <el-dropdown-item @click.native="dialogFormVisible = true">社区</el-dropdown-item>
                        </el-dropdown-menu>
                    </el-dropdown>
                         客服 关于 反馈
                    </span>
                    <span style="float: right">
                        <el-button icon="el-icon-user-solid" @click="sign" >登录</el-button>
                    </span>
            ...
            <el-footer style="height: 20%;width: 100%" >
                ...
                <div style="float: left;width: 20%;color: white">
                    <div style="margin-top: 20px"><I>找游戏</I></div>
                ...
                <div style="float: left;width: 20%;color: white">
                    <div style="margin-top: 20px"><I>交流群</I></div>
                ...
                <div style="float: left;width: 20%;color: white">
                    <div style="margin-top: 20px"><I>联系合作</I></div>
