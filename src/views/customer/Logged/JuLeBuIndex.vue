<template>
    <div>
        <div style="width: 30%;float: left;height: 100%">
            ...
            <el-card v-for="item in consoless"  v-loading="loading">
                    ...
                    <div style="float: left">
                        ...
                        <el-link @click="julebu(item)"> {{item.gameName}}</el-link> <br>
                        <el-link @click="julebu(item)">
                            {{item.gameCode}}
                        </el-link>
        ...
        <div style="float: left;width: 70%">
            ...
            <h1  style="margin-left: 20%">文章展示</h1>
    ...
    export default {
        ...
        methods:{
            julebu(item){
                ...
                window.sessionStorage.setItem("form",JSON.stringify(item))
            },
            getList(){
                this.loading = true
